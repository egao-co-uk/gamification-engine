...
class TestAchievementEvaluationType(BaseDBTest):
    ...
    def test_evaluate_achievement_for_weekly_evaluation_case1(self):
        ...
        next_date = Achievement.get_datetime_for_evaluation_type(
            achievement.evaluation_timezone, evaluation_type="weekly", dt=next_weekdate
        )
    ...
    def test_evaluate_achievement_for_monthly_evaluation_case1(self):
        ...
        next_date = Achievement.get_datetime_for_evaluation_type(
            achievement.evaluation_timezone, evaluation_type="monthly", dt=next_month
        )
    ...
    def test_evaluate_achievement_for_monthly_evaluation_case3(self):
        ...
        next_date = Achievement.get_datetime_for_evaluation_type(
            achievement.evaluation_timezone,
            evaluation_type="monthly",
            dt=achievement_date + datetime.timedelta(10),
        )
        Value.increase_value(
            variable_name="invite_users",
            user=user,
    ...
    def test_evaluate_achievement_for_yearly_evaluation_case1(self):
        ...
        next_date = Achievement.get_datetime_for_evaluation_type(
            achievement.evaluation_timezone, evaluation_type="yearly", dt=next_year
        )
    ...
    def test_evaluate_achievement_for_yearly_evaluation_case3(self):
        ...
        next_date = Achievement.get_datetime_for_evaluation_type(
            achievement.evaluation_timezone,
            evaluation_type="yearly",
            dt=achievement_date + datetime.timedelta(110),
        )
