...
def upgrade():
    ...
    op.create_index(
        op.f("ix_tasks_is_manually_modified"),
        "tasks",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["task_id"],
            ["tasks.id"],
            name=op.f("fk_taskexecutions_task_id_tasks"),
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("id", name=op.f("pk_taskexecutions")),
    )
    op.create_index(
        op.f("ix_taskexecutions_canceled_at"),
        "taskexecutions",
        ["canceled_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_taskexecutions_finished_at"),
        "taskexecutions",
        ["finished_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_taskexecutions_locked_at"),
        "taskexecutions",
        ["locked_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_taskexecutions_planned_at"),
        "taskexecutions",
        ["planned_at"],
        unique=False,
    )
