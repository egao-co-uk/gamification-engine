...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["grouptype_id"],
            ["grouptypes.id"],
            name=op.f("fk_grouptypes_grouptypes_grouptype_id_grouptypes"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["part_of_id"],
            ["grouptypes.id"],
            name=op.f("fk_grouptypes_grouptypes_part_of_id_grouptypes"),
            ondelete="CASCADE",
        ),
        ...
        sa.UniqueConstraint(
            "grouptype_id",
            "part_of_id",
            name=op.f("uq_grouptypes_grouptypes_grouptype_id"),
        ),
    )
    op.create_index(
        op.f("ix_grouptypes_grouptypes_grouptype_id"),
        "grouptypes_grouptypes",
        ["grouptype_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_grouptypes_grouptypes_part_of_id"),
        "grouptypes_grouptypes",
        ["part_of_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["group_id"],
            ["groups.id"],
            name=op.f("fk_groups_groups_group_id_groups"),
            ondelete="CASCADE",
        ),
        sa.ForeignKeyConstraint(
            ["part_of_id"],
            ["groups.id"],
            name=op.f("fk_groups_groups_part_of_id_groups"),
            ondelete="CASCADE",
        ),
    ...
    op.create_index(
        op.f("ix_groups_groups_part_of_id"),
        "groups_groups",
        ["part_of_id"],
        unique=False,
    )
    ...
    op.create_foreign_key(
        op.f("fk_groups_grouptype_id_grouptypes"),
        "groups",
        "grouptypes",
        ["grouptype_id"],
        ["id"],
